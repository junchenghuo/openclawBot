...
export const en: TranslationMap = {
  ...
  config: {
    ...
    diff: {
      pendingCountOne: "View {count} pending change",
      pendingCountMany: "View {count} pending changes",
    },
    loading: {
    ...
    node: {
      ...
      arrayCountOne: "{count} item",
      arrayCountMany: "{count} items",
      add: "Add",
    ...
    fields: {
      ...
      agents: {
        label: "Agents",
        help: "Agent runtime defaults and per-agent entries, including model/workspace/tool behavior and session policies.",
        defaults: {
          label: "Agent Defaults",
          help: "Shared default settings inherited by agents unless overridden per entry in agents.list.",
        },
        list: {
          label: "Agent List",
          help: "Per-agent overrides used for specialized workspaces, models, skills, and channel routing.",
        },
      },
      auth: {
        label: "Authentication",
        help: "Authentication profiles and failover/cooldown settings used by OpenClaw model providers.",
        profiles: {
          label: "Auth Profiles",
